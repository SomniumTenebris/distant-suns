...
class Player(Spaceship): #Maybe class inheritance could be used to simplify spaceship code across player and enemies
    ...
    def shoot(self, projectile_list):
        if self.shoot_cooldown <= 0:
            projectile_list.add(Bullet(self.portA[0], self.portA[1], "Player", 10, self.angle, 20))
            projectile_list.add(Bullet(self.portB[0], self.portB[1], "Player", 10, self.angle, 20))
