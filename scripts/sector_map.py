...
#NOTE: I need to coordinate the map system to
# 1) Center itself on the given player location
# 2) Have correct relative distances and support planetary landing
...
class Map():
    ...
    def __init__(self, planets):
        ...
        #-- Set Offsets --#
        self.offset = [0, 0]#[100, 800] #To allow space for legend
    ...
    def drawPlanets(self):
        for i in self.planets:
            ...
            gbv.screen.blit(i.tiny, i.chart_pos)
    ...
    def draw_player(self, player):
        chart_pos = [(player.x + self.global_coords[0])/self.zoom + self.offset[0],
                    (player.y + self.global_coords[1])/self.zoom + self.offset[0]]#Update tiny planet pos

        pygame.draw.circle(gbv.screen, (0, 255, 0), chart_pos, 10)
    ...
    def update(self):
        ...
        gbv.screen.blit(self.legend, (self.legend_rect[0], self.legend_rect[1]))
